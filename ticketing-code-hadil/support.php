                                ...
                                if(mysqli_num_rows($query_run) > 0)
                                {
                                    foreach($query_run as $request)
                                    {
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <button type="button" id="<?=$request['id'];?>" class="showUserRequest btn btn-primary" data-bs-toggle="modal" style="font-size: 12px; border-radius: 16px; border: 1px solid #8bc34a; background-color: #8bc34a3b; color: #8bc34a;">
                                                    show
                                                </button>
                                            </td>
